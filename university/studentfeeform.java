...
public class studentfeeform extends JFrame implements ActionListener {
    ...
    studentfeeform() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/SIT.png"));
      ...
      labelfname = new JLabel();
        ...
        String course[] = {"Btech", "Mechanical", "Civil","Electronics", "Robotics","Computer Science"};
        ...
        String branch[] = {"Computer Science", "Electronics", "Mechanical", "Civil", "Robotics","Btech"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                String query = "insert into collegef values('"+rollno+"', '"+course+"', '"+branch+"', '"+semester+"', '"+total+"')";
