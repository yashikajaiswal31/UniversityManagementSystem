...
public class updatefaculty extends JFrame implements ActionListener{
    ...
    Choice cEmpId;
       ...
       updatefaculty() {
        ...
        JLabel lblxii = new JLabel("Experience");
       ...
       labelaadhar = new JLabel();
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelx.setText(rs.getString("Degree"));
                labelxii.setText(rs.getString("work_experience"));
            ...
            public void itemStateChanged(ItemEvent ie) {
                try {
                    ...
                    while(rs.next()) {
                        ...
                        tfphone.setText(rs.getString("phone"));
                        tfemail.setText(rs.getString("email"));
                        labelx.setText(rs.getString("work_experience"));
                        labelxii.setText(rs.getString("Degree"));
                        labelaadhar.setText(rs.getString("aadhar"));
                        tfcourse.setText(rs.getString("course"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', course='"+course+"'where empID='"+empId+"'";
                Conn con = new Conn();
