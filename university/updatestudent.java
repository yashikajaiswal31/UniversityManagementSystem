...
public class updatestudent extends JFrame implements ActionListener{
    ...
    JLabel   labelfname,  labeldob,labelaadhar,labelrollno ,  labelname,  lblxii,lblx,labelxii ,labelx;
       ...
       labelaadhar = new JLabel();
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelx.setText(rs.getString("class_10"));
                labelxii.setText(rs.getString("class_12"));
